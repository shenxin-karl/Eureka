...
constexpr static std::size_t kMaxRootParameter = 16;				// 最多16个根签名
constexpr static std::size_t kMaxDescriptor = 512;					// 根签名中最多512个描述符
constexpr static std::size_t kMaxDescriptorInRootParameter = 255;	// 单个根参数最大255个描述符
