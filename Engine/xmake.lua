...
add_requires("assimp",  {debug = isDebug, configs = {vs_runtime = ERUEKA_VS_RUNTIME, shared = false}})
add_requires("antlr4",  {debug = isDebug, configs = {vs_runtime = ERUEKA_VS_RUNTIME, shared = false}})
