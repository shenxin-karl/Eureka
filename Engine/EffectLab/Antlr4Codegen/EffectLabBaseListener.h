...
public:
  ...
  virtual void enterProperty_space(EffectLabParser::Property_spaceContext * /*ctx*/) override { }
  virtual void exitProperty_space(EffectLabParser::Property_spaceContext * /*ctx*/) override { }
