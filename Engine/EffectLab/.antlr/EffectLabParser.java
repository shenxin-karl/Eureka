...
public class EffectLabParser extends Parser {
	...
	public static final int
		RULE_effect = 0, RULE_source_path = 1, RULE_property_block = 2, RULE_number_val = 3, 
	...
	public EffectLabParser(TokenStream input) {
		super(input);
		_interp = new ParserATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}

	public static class EffectContext extends ParserRuleContext {
		public Source_pathContext source_path() {
			return getRuleContext(Source_pathContext.class,0);
		}
	...
	public static class Source_pathContext extends ParserRuleContext {
		public TerminalNode String() { return getToken(EffectLabParser.String, 0); }
		public Source_pathContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_source_path; }
	}

	public final Source_pathContext source_path() throws RecognitionException {
		Source_pathContext _localctx = new Source_pathContext(_ctx, getState());
		enterRule(_localctx, 2, RULE_source_path);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(34);
	...
	public static class Number_valContext extends ParserRuleContext {
		public TerminalNode IntVal() { return getToken(EffectLabParser.IntVal, 0); }
		public TerminalNode FloatVal() { return getToken(EffectLabParser.FloatVal, 0); }
	...
	public static class Property_bool_valContext extends ParserRuleContext {
		public TerminalNode BoolVal() { return getToken(EffectLabParser.BoolVal, 0); }
	...
	public static class Property_matrixContext extends ParserRuleContext {
		public TerminalNode KWIdentity() { return getToken(EffectLabParser.KWIdentity, 0); }
	...
	public static class Property_nameContext extends ParserRuleContext {
		public TerminalNode Identity() { return getToken(EffectLabParser.Identity, 0); }
