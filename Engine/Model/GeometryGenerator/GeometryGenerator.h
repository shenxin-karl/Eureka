...
public:
	...
	auto createBox(float width, float height, float depth, uint32 numSubdivisions) const -> std::shared_ptr<PartMesh>;
	auto createSphere(float radius, uint32 numSubdivisions) const -> std::shared_ptr<PartMesh>;
